...
exports.run = async(client, message, args) => {
   ...
   if(!member) {
    ...
    let vip = message.guild.roles.cache.find(r => r.id === '875845840030277640')//Viprolİd Koy
  ...
  .setImage('https://media.giphy.com/media/l6Td5sKDNmDGU/giphy.gif') 
    client.channels.cache.get('925071036846862356').send(embed)///LOG KANAL İD YAZMALISIN
}
