...
exports.run = async(client, message, args) => {
   ...
   if(!member) {
    ...
    let erkek = message.guild.roles.cache.find(r => r.id === '875845840030277635')
    let kayıtsız = message.guild.roles.cache.find(r => r.id === '875845840013525008')
   ...
   .addField('Kayıt eden yetkili', message.author)
    client.channels.cache.get('925074465996546148').send(embed)///LOG KANAL İD YAZMALISIN
}
